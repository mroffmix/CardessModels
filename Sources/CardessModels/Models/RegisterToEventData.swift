...
public class RegisterToEventData: Codable, Equatable {
  ...
  public func isEqual(to object: Any?) -> Bool {
    guard let object = object as? RegisterToEventData else { return false }
    ...
    guard self.preferredTime == object.preferredTime else { return false }
  ...
  public static func == (lhs: RegisterToEventData, rhs: RegisterToEventData) -> Bool {
