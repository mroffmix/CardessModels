...
public class CommunicationImportImportEntityResponse: Codable, Equatable {
  ...
  public func isEqual(to object: Any?) -> Bool {
    guard let object = object as? CommunicationImportImportEntityResponse else { return false }
  ...
  public static func == (lhs: CommunicationImportImportEntityResponse, rhs: CommunicationImportImportEntityResponse) -> Bool {
