...
public class CallRedirectSettingsInfo: Codable, Equatable {
  ...
  public init(callToReception: Bool?  = nil, id: String? = nil, leadSource: CustomerDataEnumsLeadSource?  = nil, phoneNo: String?  = nil, preventFallback: Bool?  = nil, users: [UserInfo]?  = nil) {
  ...
  public func isEqual(to object: Any?) -> Bool {
    guard let object = object as? CallRedirectSettingsInfo else { return false }
  ...
  public static func == (lhs: CallRedirectSettingsInfo, rhs: CallRedirectSettingsInfo) -> Bool {
