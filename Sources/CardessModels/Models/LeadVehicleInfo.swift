...
public class LeadVehicleInfo: Codable, Equatable {
  ...
  public func isEqual(to object: Any?) -> Bool {
    guard let object = object as? LeadVehicleInfo else { return false }
  ...
  public static func == (lhs: LeadVehicleInfo, rhs: LeadVehicleInfo) -> Bool {
