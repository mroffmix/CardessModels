...
public class ModelChatMessage: Codable, Equatable {
  ...
  public var sender: ModelUser?
  public var senderId: String?
  public var threadId: String?

  public init(createdOn: Date? = nil, id: String? = nil, lead: ModelLead?  = nil, leadId: String? = nil, message: String?  = nil, messageSource: EnumsMessageSource?  = nil, messageType: EnumsMessageType?  = nil, modifiedOn: Date? = nil, sender: ModelUser?  = nil, senderId: String? = nil, threadId: String?  = nil) {
  ...
  public func isEqual(to object: Any?) -> Bool {
    guard let object = object as? ModelChatMessage else { return false }
  ...
  public static func == (lhs: ModelChatMessage, rhs: ModelChatMessage) -> Bool {
